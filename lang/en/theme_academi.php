...
$string['loginbackgroundimage'] = 'Login Left background image';
$string['loginbackgroundimage_desc'] = 'Image displayed as the background on the left side of the login page.';
$string['loginbg'] = 'Login Right background image';
$string['loginbg_desc'] = 'Image displayed as the background on the right side of the login page.';
$string['logo'] = 'Logo';
...
$string['showdefaultloginpanel'] = 'Display default login panel instructions';
$string['showdefaultloginpanel_desc'] = 'If enabled, the theme will display the default welcome title, tagline and stats on the login left panel when no custom authentication instructions are configured.';
