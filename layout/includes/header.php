  ...
  <div class="header-main">
  	<div class="container-fluid">
    	<div class="row-fluid">
      	...
      	<div class="span7">
        	<div class="infoarea">
            <span><i class="fa fa-phone"></i><?php echo get_string('callus','theme_academi');?>: <?php echo theme_academi_get_setting('phoneno'); ?></span>
            <span><i class="fa fa-envelope-o"></i><?php echo get_string('email','theme_academi');?>: <?php echo theme_academi_get_setting('emailid'); ?></span>
          </div>
        </div>
      </div>
    </div>
